...
{
    [gardener-shoot-clusterResourceType("gardener-shoot-cluster:index:StaticPage")]
    public partial class StaticPage : Pulumi.ComponentResource
    {
        ...
        public StaticPage(string name, StaticPageArgs args, ComponentResourceOptions? options = null)
            : base("gardener-shoot-cluster:index:StaticPage", name, args ?? new StaticPageArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }

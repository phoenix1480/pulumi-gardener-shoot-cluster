...
namespace Pulumi.gardener-shoot-cluster
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.gardener-shoot-cluster.version.txt");
    ...
    internal sealed class gardener-shoot-clusterResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public gardener-shoot-clusterResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
